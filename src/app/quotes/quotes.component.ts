...
// Hide quote entry section.
  ...
  quotes = [
    ...
    new Quote('Do not train a child to learn by force or harshness; but direct them to it by what amuses their minds, so that you may be better able to discover with accuracy the peculiar bent of the genius of each.', 'Plato', 'Admin', new Date(220, 5, 8, 7, 45), 0, 0),
